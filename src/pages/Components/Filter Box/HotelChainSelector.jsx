...
import styles from "../Styles/Filter Box Styles/HotelChainSelector.module.css"

function HotelChainSelector(props) {
  ...
  // This function will be called when the user clicks on the dropdown to select an option
  // Change this to implement functionality when the user selects an option
